...
import { SERVICE_CATEGORIES } from "@/config/branding";
import { COMPANY_INFO } from "@/config/branding";
import { ProfessionalNav } from "@/components/navigation/ProfessionalNav";
import { ProfessionalCard, ServiceCard, StatCard } from "@/components/cards/ProfessionalCards";
...
const features = [
  { icon: Clock, title: "Resposta em 2 Horas", description: "Atendimento ágil e eficiente" },
  {
    icon: CheckCircle2,
    title: "Certificações Profissionais",
    description: "Equipe com certificações internacionais",
  },
  { icon: Shield, title: "Qualidade Garantida", description: "100% de satisfação do cliente" },
  {
    icon: Users,
